...
export const {{appName}}AnchoredRegion = () => fastAnchoredRegion();

export {AnchoredRegion} from '@microsoft/fast-components';

export const defaultAnchoredRegionConfig = defaultConfig;
export const {{appName}}AnchoredRegionTemplate = template;
export const {{appName}}AnchoredRegionStyles = styles;
export const {{appName}}AnchoredRegionShadowOptions = shadowOptions;
